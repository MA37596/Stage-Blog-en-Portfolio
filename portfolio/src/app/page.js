...
export default function HomePage() {
  ...
  const texts = {
    nl: {
      ...
      project3: "Een gamified buurtapp waarin bewoners punten verdienen door activiteiten voor de wijk te doen en deze kunnen inwisselen voor kortingen bij lokale winkels.",
      project4: "Werkend e-commerce website gemaakt met HTML CSS en JavaScript.",
      project5: "Interactive afsprakenplanner gemaakt met PHP, CSS en SQL.",
      project6: "Een persoonlijke ‘About Me’-website gebouwd in React, met een geïntegreerde top 10 van favoriete albums en een ingebouwde cookie-clicker game.",
      casino: "Casino site",
    ...
    en: {
      ...
      project3: "A gamified community app where residents earn points for neighborhood activities and can redeem them for discounts at local stores.",
      ...
      project6: "A personal 'About Me' website built in React, with a top 10 favorite albums section and a built-in cookie-clicker game.",
      casino: "Casino site",
      mrRobot: "Mr Robot Capture The Flag",
      mobileApp: "Mobile App UI/UX",
      ecommerce: "E-commerce Website",
    ...
    >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="w-full h-48 rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                  <span className="text-white font-semibold text-lg bg-green-600/80 px-4 py-2 rounded-lg">
                    {t.cyber}
                  </span>
                </div>
              </div>
              <h3 className="text-xl font-semibold mb-2">{t.mrRobot}</h3>
              <p className={`mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                {t.project2}
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">{t.mobileApp}</h3>
              <p className={`mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                {t.project3}
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2">{t.afsprakenplanner}</h3>
              <p className={`mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                {t.project5}
              </p>
              <div className="flex flex-wrap gap-2">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-10">
          ...
          ></div>
          <div
            className={`absolute top-1/2 left-1/4 w-16 h-16 border rounded-full ${
